...
const Contact: FunctionComponent = () => {
    ...
    const mainCategories: {
        ...
        {
            name: t('categories.Electronics.label'),
            icon: '📱',
            color: 'primary',
        },
        { name: t('categories.Cars.label'), icon: '🚗', color: 'secondary' },
        {
            name: t('categories.WomenClothes.label'),
            icon: '👚',
            color: 'success',
        },
        { name: t('categories.MenClothes.label'), icon: '👔', color: 'info' },
