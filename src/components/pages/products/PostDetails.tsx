...
const PostDetails: FunctionComponent = () => {
    ...
    const sellerDisplayName = post.seller?.name || 'user';
                                                    ...
                                                    (review, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                ...
                                                                auth?._id
                                                                    ? t('you')
                                                                    : `${review.user?.name.first} ${review.user?.name.last || 'مستخدم مجهول'} `}
                                                            </Typography>
                                                            <Rating
                                                                value={
                                                                    review.rating ||
                                    ...
                                    >
                                        <Stack spacing={2.5}>
                                            ...
                                            <Box>
                                                ...
                                                >
                                                    {post.description ||
                                                        'لم تتم إضافة وصف تفصيلي لهذا المنتج بعد.'}
                                                </Typography>
                                            </Box>
                                    ...
                                    >
                                        ...
                                        <Stack spacing={2.5}>
                                            ...
                                            <Alert
                                                ...
                                                sx={{ borderRadius: 2 }}
                                            >
                                                للاستفسار عن المنتج أو تقديم
                                                شكوى، يرجى التواصل عبر الهاتف
                                                0538346915 أو البريد الإلكتروني
                                                support@safqa.com.
                                            </Alert>
                                            ...
                                            <Typography
                                                ...
                                                sx={{ lineHeight: 1.8 }}
                                            >
                                                يعرض هذا التصميم المعلومات
                                                الأساسية أولاً، ثم ينقل المستخدم
                                                إلى التفاصيل والدعم في أقسام
                                                منفصلة وواضحة، مما يحسن تجربة
                                                التصفح ويُسهّل اتخاذ القرار.
                                            </Typography>
                                        </Stack>
                                    </Card>
                                </Stack>
