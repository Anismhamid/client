...
export const fontAwesomeIcon = {
    ...
    databaseLock: <FontAwesomeIcon icon={faDatabase} />,
    loginLock: <FontAwesomeIcon icon={faUserLock} />,
    postLock: <FontAwesomeIcon icon={faCircleMinus} />,
    messageLock: <FontAwesomeIcon icon={faCommentSlash} />,
    offerLock: <FontAwesomeIcon icon={faTags} />,
