    ...
    WomenBags: {
        handbags: [
            ...
            { name: 'color', type: 'text' },
            {
                name: 'material',
                type: 'select',
                options: ['Leather', 'PU Leather', 'Fabric', 'Suede'],
            },
            {
                name: 'strapType',
                type: 'select',
                options: ['Handheld', 'Shoulder', 'Crossbody', 'Adjustable'],
            },
        ],
        ...
        toteBags: [
            ...
            { name: 'color', type: 'text' },
            {
                name: 'material',
                type: 'select',
                options: ['Canvas', 'Leather', 'Nylon', 'PU Leather'],
            },
            { name: 'pocketCount', type: 'number' },
        ],
        ...
        clutches: [
            ...
            { name: 'color', type: 'text' },
            {
                name: 'occasion',
                type: 'select',
                options: ['Evening', 'Wedding', 'Party', 'Formal'],
            },
        ],
    },
