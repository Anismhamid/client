            ...
            >
                ...
                >
                    <Link
                        ...
                        style={{ textDecoration: 'none', color: 'inherit' }}
                        title={
                            t('ads.createAdDescription') ||
                            'Promote your ad to increase its visibility. Choose your budget and campaign duration to start attracting more potential buyers.'
                        }
                    >
                        <ListItemIcon sx={{ minWidth: 40 }}>
                            <DashboardIcon
                        ...
                        <Typography
                            variant='body2'
                            aria-label={t('ads.createAd') || 'Create Ad'}
                            sx={{ color: 'text.primary' }}
                        >
                ...
                >
                    ...
                    >
                        ...
                        <Typography
                            variant='body2'
                            sx={{ color: 'text.primary' }}
                            aria-label={t('ads.dashboard') || 'Ads Dashboard'}
                        >
